        ...
        <div className="container">
          <div className="form_card min-h-screen flex justify-center items-center">
            <div className="flex flex-wrap gap-5 lg:justify-between justify-center items-stretch bg-white shadow-xl dark:bg-gray-500 rounded-xl p-4 w-full">
              <div className="w-full lg:w-[calc(100%_/_2_-_10px)] mlg:order-2">
                <form
                ...
                >
                  <div className="mx-auto max-w-sm">
                    ...
                    <p className="text-[1rem] text-gray-500 text-center dark:text-gray-100">
                      ...
                      <a href="/login" className="text-[0.9rem] underline">
                        Login Now
                      </a>{" "}
                      ?
                    </p>
              ...
              <div className="w-full lg:w-[calc(100%_/_2_-_10px)] mlg:order-1">
...
<Image
                  ...
                  <img
                    ...
                    className="max-w-[1100px] h-[400px] z-20 hidden dark:inline-block rounded-xl absolute bottom-0 left-[20%] drop-shadow-xl"
                    alt=""
                  />
