            ...
            <nav className="bg-white border-gray-200 dark:bg-slate-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex gap-3 items-center">
                        ...
                        <IoCarSportOutline className="self-center text-[3rem] text-[var(--theme)] font-semibold whitespace-nowrap dark:text-cyan-200" />
                    ...
                    <div
                        ...
                        id="navbar-default"
                    >
                        <ul className="font-medium flex flex-col p-4 md:p-0 border h-full border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-slate-900 md:dark:bg-slate-900 dark:border-slate-900">
                            <li>
                                <a
                                    href="/"
                                    className="block py-2 px-3 font-medium text-[1rem] uppercase text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-cyan-200"
                                    aria-current="page"
                                >
                                    Home
                                </a>
                            ...
                            <li>
                                <a
                                    href="/about"
                                    className="block py-2 px-3 font-medium text-[1rem] uppercase text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-cyan-200 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                                >
                                    About
                                </a>
                            </li>
