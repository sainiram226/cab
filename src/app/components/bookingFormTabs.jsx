...
export default function BookingFormTabs() {
    ...
    return (
        <>
            <div className="card transition-all duration-300 bg-white dark:bg-slate-900">
                <div>
                    <ul className="list-none flex justify-between items-center w-full bg-white border-b-2">
                        <li
                            className={`tab-button ${activeTab === 0
                                ? "active px-3 py-3 rounded-ee-md cursor-pointer text-blue-500 transition-all text-center duration-300 font-bold border border-blue-500 w-1/2"
                                : "transition-all duration-300 px-3 py-3 cursor-pointer text-center text-black font-bold bg-white w-1/2"
                                }`}
                        ...
                        <li
                            className={`tab-button ${activeTab === 1
                                ? "active px-3 py-3 rounded-b-md cursor-pointer text-blue-500 transition-all text-center duration-300 font-bold border border-blue-500 w-1/2"
                                : "transition-all duration-300 px-3 py-3 cursor-pointer text-center text-black font-bold bg-white w-1/2"
                                }`}
                        ...
                        <li
                            className={`tab-button ${activeTab === 2
                                ? "active px-3 py-3 rounded-es-md cursor-pointer text-blue-500 transition-all text-center duration-300 font-bold border border-blue-500 w-1/2"
                                : "transition-all duration-300 px-3 py-3 cursor-pointer text-center text-black font-bold bg-white w-1/2"
                                }`}
